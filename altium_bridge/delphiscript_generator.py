...
def generate_delphiscript(component: dict) -> str:
    ...
    lines.append("    If Not Supports(SchServer.GetCurrentSchDocument, ISch_Lib, CurrentLib) Then Begin")
    lines.append("        ShowMessage('No Schematic Library document is focused. Open/create a .SchLib and try again.');")
    lines.append("        Exit;")
    lines.append("    End;")
    lines.append("")
